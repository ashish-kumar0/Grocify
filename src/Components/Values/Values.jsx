...
const value =[
    {
        id: 1,
        title: 'Trust',
        para: 'It is a long established fact that a render will be directed by the readables.',
        icon: <FaHeart />
    },
    {
        id: 2,
        title: 'Always Fresh',
        para: 'It is a long established fact that a render will be distracted by the readables',
        icon: <FaLeaf />
    },
    {
        id: 3,
